...
impl<T: From<i8> + Clone> Matrix<[[T; 3]; 3]> {
    pub fn identity() -> Self {
        Matrix([[n(1), n(0), n(0)], [n(0), n(1), n(0)], [n(0), n(0), n(1)]])
    }
    ...
    pub fn transpose(self) -> Self {
        let Matrix([[a11, a12, a13], [a21, a22, a23], [a31, a32, a33]]) = self;
...
impl<T: Copy + Add<Output = T> + Mul<Output = T>> Mul for Matrix<[[T; 3]; 3]> {
    ...
    fn mul(self, that: Self) -> Self {
        let Matrix([[a11, a12, a13], [a21, a22, a23], [a31, a32, a33]]) = self;
        let Matrix([[b11, b12, b13], [b21, b22, b23], [b31, b32, b33]]) = that;
        Matrix([
            [
...
impl<T: From<i8>> Matrix<[[T; 4]; 4]> {
    pub fn embed_matrix3(m: Matrix<[[T; 3]; 3]>) -> Self {
        let Matrix([[a11, a12, a14], [a21, a22, a24], [a41, a42, a44]]) = m;
        Matrix([
            [a11, a12, n(0), a14],
            [a21, a22, n(0), a24],
            [n(0), n(0), n(1), n(0)],
